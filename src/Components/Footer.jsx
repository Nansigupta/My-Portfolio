...
const Footer = () => {
  return (
    <div id='footer' className='container-fluid py-4 mt-3 bg-dark'>
      <div className='row align-items-center'>
        ...
        <div className='col-12 col-md-4 text-center mb-2 mb-md-0'>
          <p className='mb-0 text-wrap fs-4 text-info'>
            Copyright &copy; 2025 {personalData.name} | All Rights Reserved
          </p>
        </div>
